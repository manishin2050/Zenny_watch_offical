  ...
  return (
    <footer className="bg-gray-50 text-primary py-16 ">
      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-4 shadow-sm pt-8 pb-8">
          {/* Company Info */}
          <div>
          ...
          <div>
            ...
            <p className="text-gray-900 hover:text-[#c58e46] mb-4"> 1234 Fashion Street, Suite 567, New York, NY</p>
            <p className="text-gray-900 hover:text-[#c58e46] mb-4"> contact@example.com</p>
            <p className="text-gray-900 hover:text-[#c58e46] mb-4"> +84 (212)555-1234</p>
            <p className="text-gray-900 font-bold mb-1"> Working hours:</p>
            <p className="text-gray-900  mb-4"> Mon – Sat 9.00 – 18.00</p>
           
          </div>
        </div>

        <div className=" mt-12 pt-8 text-center">
          <p className="text-gray-700">&copy; 2024 ZENNY. All rights reserved. | Designed with luxury in mind.</p>
        </div>
      </div>
    </footer>
  );
